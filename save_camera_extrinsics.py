...
t_bc = np.array([0.7257, 0.6421, 0.5705])  # meters
# t_bc = np.array([0.7157, 0.6381, 0.5705])  # meters
# multiply to get in milimeters
# t_bc = t_bc * 1000.0  # mm
q_bc = np.array([0.256298, 0.263371, -0.646286, 0.668776])  # [x,y,z,w]
